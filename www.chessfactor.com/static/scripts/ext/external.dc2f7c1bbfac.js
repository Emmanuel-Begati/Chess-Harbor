...
// carousel arrows
var navArrows = ["\n    <svg class=\"icon icon-arrow-prev\">\n        <use xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=\"/static/images/ext_images/sprite.svg#icon-arrow-prev\"></use>\n    </svg>", "<svg class=\"icon icon-arrow-next\">\n        <use xmlns:xlink=\"http://www.w3.org/1999/xlink\" xlink:href=\"/static/images/ext_images/sprite.svg#icon-arrow-next\"></use>\n    </svg>"];
...
// language
(function () {
    var head = $('.js-language-head'),
        body = $('.js-language-body');
    head.on('click', function (e) {
        if ($(window).width() > 767) {
            e.preventDefault();
            head.toggleClass('active');
...
(function () {
    ...
    head.on('click', function () {
        var thisHead = $(this);
        if (!thisHead.parent('.js-faq-item').hasClass('active')) {
            item.removeClass('active');
            body.slideUp();
            thisHead.parent('.js-faq-item').addClass('active');
            thisHead.next().slideDown();
        } else {
            head.parent('.js-faq-item').removeClass('active');
            body.slideUp();
        }
    });
})();
...
// support
(function () {
    var money = $('.js-supp-money'),
        gift = $('.js-supp-gift'),
        close = $('.js-supp-close');
    variant = $('.js-supp-variant');
...
(function () {
    ...
    if ($(window).width() < 767) {
        tabs.each(function () {
            var thisTabs = $(this),
                nav = thisTabs.find('.js-effect-link'),
                item = thisTabs.find('.js-effect-item');
            nav.on('click', function () {
                var thisNav = $(this),
                    indexNav = thisNav.index();
                nav.removeClass('active');
...
function AddReadMore() {
    ...
    var readMoreTxt = " <span class='SecDots'>...</span> <span class='SecText'>more</span>";
    // Text to show when text is expanded
    var readLessTxt = " <span class='SecText'>less</span>";
    ...
    $(".addReadMore").each(function () {
        ...
        var trimRegExp = new RegExp("^(.{" + carLmt + "}[^(\\s|-|,|:|.|\")]*).*");
        if (allstr.length > carLmt) {
            var firstSet = allstr.substring(0, carLmt);
            //For soft word breaking
            // var firstSet = allstr.replace(trimRegExp, "$1");
    ...
    $('.readMore').on('click', function () {
        ...
        thisReadMore.parent('.review__text').next().show();
        thisReadMore.parents('.review__item').find('.review__peak').show();
    });
    $('.readLess').on('click', function () {
        var thisReadLess = $(this);
        thisReadLess.parent('.review__text').next().hide();
        thisReadLess.parents('.review__item').find('.review__peak').hide();
    });
}
$(function () {
